...
if __name__ == "__main__":
    ...
    print('{0:3.1f}\t {1:3.2f}\t {2:3.2f}\t {3:1.2f}\t {4:3.2f}\t {5:3.2f}\t {6:3.2f}\t {7:3.1f} \t {8:3.1f}'.format(vals['B'].value,grad(vals['gamma'].value),grad(vals['xi'].value),vals['vlos'].value, vals['eta0'].value,vals['a'].value,vals['ddop'].value,vals['S_0'].value,vals['S_1'].value))
    ...
    p0.add('vlos',  value=vals['vlos'].value, vary=False)
    p0.add('eta0',  value=vals['eta0'].value, min=0.0, max = 10.0, vary=True)
    p0.add('a',     value=vals['a'].value,    min=0.0, max = 10.0,  vary=False)
    p0.add('ddop',  value=vals['ddop'].value, min=0.0, max = 0.5,  vary=False)
    p0.add('S_0',   value=vals['S_0'].value,  min=0.0, max = 1.5,  vary=False)
    p0.add('S_1',   value=vals['S_1'].value,  min=0.0, max = 1.5,  vary=False)
